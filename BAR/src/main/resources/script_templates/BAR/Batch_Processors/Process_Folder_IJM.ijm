 ...
 *
 * This macro implements a yet one more reusable batch processor that processes
 * a folder of files of a certain type. It is a more flexible alternative to the
 * IJ1 Process>Batch>Macro built-in command. See also other IJ1 batch processors
