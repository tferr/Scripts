...
`BAR> Utilities> New Routine...`. They also exemplify how to access [lib] files, using the
default template libs (those installed locally using
`BAR> Utilities> Install Multi-language libs...`) as a starting point.
