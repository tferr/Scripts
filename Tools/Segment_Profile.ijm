...
function promptForOptions() {
	msg = "<html><div WIDTH=450>This tool extracts the segments within a straight line that are "
		+ "above threshold levels. Extracted segments are stored in the image overlay.<br><br>"
		+ "<b>Smallest segment length</b><br>"
		+ "The minimum length segments can have. Shorter segments will be "
		+ "ignored. Set it to 0 (the default) to include all segments within the "
		+ "profiled line.<br><br>"
		+ "<b>Do not highlight threshold levels</b><br>"
		+ "If active, the specified threshold value is used, and thresholded "
		+ "pixels are not highlighted.<br><br>"
		+ "<b>Undo last segmentation</b><br>"
		+ "Removes all segments from the last segmented line. Alt-click on "
		+ "the image canvas to remove just the last segment.<br><br>"
		+ "<b>Run demo</b><br>"
		+ "If selected, a demonstrative segmentation of the <i>Tree Rings</i> sample "
