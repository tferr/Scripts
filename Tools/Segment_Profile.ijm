...
function promptForOptions() {
	msg = "<html>This tool extracts the segments within a straight line that are above<p>"
		+ "threshold levels. Extracted segments are stored in the image overlay.<p><p>"
		+ "<b>Smallest segment length</b><p>"
		+ "The minimum length segments can have. Shorter segments will be<p>"
		+ "ignored. Set it to 0 (the default) to include all segments within the<p>"
		+ "profiled line.<p><p>"
		+ "<b>Do not highlight threshold levels</b><p>"
